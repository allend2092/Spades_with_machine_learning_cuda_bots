'''
Created by Daryl on September 14th, 2024. This is a personal project to help me understand neural networks more clearly.
I've implemented my own neural networks and am teaching them how to play the card game spades.

This code leverages Nvidia GPUs. In my case, I have an Nvidia 3080 with 10 GB memory. 
When the program runs, my GPU consumes about 8 GB of memory for the models
